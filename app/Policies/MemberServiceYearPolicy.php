...
class MemberServiceYearPolicy
{
     ...
     */
    public function restore(User $user, MemberServiceYear $memberServiceYear): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, MemberServiceYear $memberServiceYear): bool
    {
        return false;
    }
}
